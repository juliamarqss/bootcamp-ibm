...
public class ProdutoServiceTest {
    ...
    public void testInsertProduto(){
        Produto produto = new Produto(1, "Celular", 2000.00);
    ...
    public void testFindProdutoByIdExistente(){
        Integer produtoId = 1;
        Produto produto = new Produto(produtoId, "Celular", 2000.00);
    ...
    @Test
    public void testFindProdutoByIdNaoEncontrado(){
    ...
    public void testUpdateProduto(){
        Integer produtoId = 1;
        Produto produtoAtualizado = new Produto(produtoId, "Celular", 2000.00);
        Produto produtoExistente = new Produto(produtoId, "Tv", 5000.00);
